		...
		>
			...
			<div className="flex flex-col gap-2 relative">
				...
				<input
					...
					className={`p-2 border rounded-xl pr-10 ${
				...
				<button
					...
					className={`absolute right-3 ${
						errors.password || isError ? "top-[40%]" : "top-[56%]"
					} text-gray-500`}
					tabIndex={-1}
			...
			<button
				...
				className={`bg-[#0071FF] text-white p-3 rounded-lg cursor-pointer transition duration-200 disabled:bg-[#0071FF99] disabled:cursor-not-allowed`}
			>
				{isPending ? "Logining in" : "Continue"}
			</button>
			<p className="text-sm text-[#5E6368] text-center ">
				Or continue with
			</p>
			<button className="rounded-lg cursor-pointer p-3 bg-[#E0E0E0] flex justify-center items-center">
				<Image
			...
			<span className="font-normal text-center">
				First time?{" "}
				<Link href="/sign-up" className="text-bright-blue ">
					{" "}
					Create an account
				</Link>
			</span>
					...
					<div className="step1 w-full rounded-4xl p-[40px] mx-auto">
						<div className="p-10  rounded-[38px]" style={styles}>
							<div className="bg-white w-full h-full p-10 rounded-[16px]">
								<h1 className="text-charcoal-black text-5xl font-bold text-center ">
									Sign in to your account
								</h1>
